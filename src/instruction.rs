...
impl From<Instruction> for u32 {
    fn from(instr: Instruction) -> u32 {
        match instr {
            Instruction::Lui(UType(x)) => x,
            Instruction::Auipc(UType(x)) => x,
            Instruction::Jal(JType(x)) => x,
            Instruction::Jalr(IType(x)) => x,
            Instruction::Beq(BType(x)) => x,
            Instruction::Bne(BType(x)) => x,
            Instruction::Blt(BType(x)) => x,
            Instruction::Bge(BType(x)) => x,
            Instruction::Bltu(BType(x)) => x,
            Instruction::Bgeu(BType(x)) => x,
            Instruction::Lb(IType(x)) => x,
            Instruction::Lh(IType(x)) => x,
            Instruction::Lw(IType(x)) => x,
            Instruction::Ld(IType(x)) => x,
            Instruction::Lbu(IType(x)) => x,
            Instruction::Lhu(IType(x)) => x,
            Instruction::Lwu(IType(x)) => x,
            Instruction::Sb(SType(x)) => x,
            Instruction::Sh(SType(x)) => x,
            Instruction::Sw(SType(x)) => x,
            Instruction::Sd(SType(x)) => x,
            Instruction::Fence(IType(x)) => x,
            Instruction::Addi(IType(x)) => x,
            Instruction::Slti(IType(x)) => x,
            Instruction::Sltiu(IType(x)) => x,
            Instruction::Xori(IType(x)) => x,
            Instruction::Ori(IType(x)) => x,
            Instruction::Andi(IType(x)) => x,
            Instruction::Slli(IType(x)) => x,
            Instruction::Srli(IType(x)) => x,
            Instruction::Srai(IType(x)) => x,
            Instruction::Addiw(IType(x)) => x,
            Instruction::Slliw(IType(x)) => x,
            Instruction::Srliw(IType(x)) => x,
            Instruction::Sraiw(IType(x)) => x,
            Instruction::Add(RType(x)) => x,
            Instruction::Sub(RType(x)) => x,
            Instruction::Sll(RType(x)) => x,
            Instruction::Slt(RType(x)) => x,
            Instruction::Sltu(RType(x)) => x,
            Instruction::Xor(RType(x)) => x,
            Instruction::Srl(RType(x)) => x,
            Instruction::Sra(RType(x)) => x,
            Instruction::Or(RType(x)) => x,
            Instruction::And(RType(x)) => x,
            Instruction::Mul(RType(x)) => x,
            Instruction::Mulh(RType(x)) => x,
            Instruction::Mulhsu(RType(x)) => x,
            Instruction::Mulhu(RType(x)) => x,
            Instruction::Div(RType(x)) => x,
            Instruction::Divu(RType(x)) => x,
            Instruction::Rem(RType(x)) => x,
            Instruction::Remu(RType(x)) => x,
            Instruction::Addw(RType(x)) => x,
            Instruction::Subw(RType(x)) => x,
            Instruction::Sllw(RType(x)) => x,
            Instruction::Srlw(RType(x)) => x,
            Instruction::Sraw(RType(x)) => x,
            Instruction::Mulw(RType(x)) => x,
            Instruction::Divw(RType(x)) => x,
            Instruction::Divuw(RType(x)) => x,
            Instruction::Remw(RType(x)) => x,
            Instruction::Remuw(RType(x)) => x,
            Instruction::Ecall(IType(x)) => x,
            Instruction::Ebreak(IType(x)) => x,
            Instruction::Lrw(RType(x)) => x,
            Instruction::Scw(RType(x)) => x,
            Instruction::Amoswapw(RType(x)) => x,
            Instruction::Amoaddw(RType(x)) => x,
            Instruction::Amoxorw(RType(x)) => x,
            Instruction::Amoandw(RType(x)) => x,
            Instruction::Amoorw(RType(x)) => x,
            Instruction::Amominw(RType(x)) => x,
            Instruction::Amomaxw(RType(x)) => x,
            Instruction::Amominuw(RType(x)) => x,
            Instruction::Amomaxuw(RType(x)) => x,
            Instruction::Lrd(RType(x)) => x,
            Instruction::Scd(RType(x)) => x,
            Instruction::Amoswapd(RType(x)) => x,
            Instruction::Amoaddd(RType(x)) => x,
            Instruction::Amoxord(RType(x)) => x,
            Instruction::Amoandd(RType(x)) => x,
            Instruction::Amoord(RType(x)) => x,
            Instruction::Amomind(RType(x)) => x,
            Instruction::Amomaxd(RType(x)) => x,
            Instruction::Amominud(RType(x)) => x,
            Instruction::Amomaxud(RType(x)) => x,
        }
    }
}
